...
@section('content_header')
    ...
    <h1>Permissões <a href="{{ route('permissions.create') }}" class="btn btn-dark">ADD <i class="far fa-plus-square"></i></a></h1>
                ...
                <tbody>
                    @foreach ($permissions as $permission)
                        <tr style="width: 10px;">
                            ...
                            <td><a href="{{ route('permissions.show', $permission->id) }}" class="btn btn-warning">Ver</a>
